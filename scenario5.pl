...
% this first specifies flow from outside
     ...
     equals(turnrate(fake,outside,hepton_south),0.03),
     equals(turnrate(fake,outside,albert_south),0.1),
     equals(turnrate(fake,outside,callans_south),0.1),
     equals(turnrate(fake,outside,trades_north),0.1),
...
% this records the length of time traffic stay in a section  in link I 
     ...
     equals(maxsectiontime(market_west),3),
     equals(maxsectiontime(new_east),3),
     equals(maxsectiontime(park_east),3),
     equals(maxsectiontime(market_east),3)
],
...
% they give the green time for each stage in the 4 traffic signals
     ...
     change_flow(50,trades_north,0.15),
     change_flow(350,trades_north,0.05),
     change_flow(750,trades_north,0.25),
     change_flow(100,hepton_south,0.07),
     change_flow(200,hepton_south,0.09),
     change_flow(300,hepton_south,0.13),
     change_flow(400,hepton_south,0.18),
     change_flow(800,hepton_south,0.23),
     change_flow(300,albert_south,0.15),
     change_flow(400,albert_south,0.18),
     change_flow(800,albert_south,0.25),
     change_flow(800,callans_south,0.1),
     change_flow(900,callans_south,0.2),
     change_flow(1000,callans_south,0.3),
     wait(pelican, 25)
],
