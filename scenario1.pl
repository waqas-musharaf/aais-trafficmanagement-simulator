...
% this first specifies flow from outside
     ...
     equals(turnrate(fake,outside,callans_south),0.08),
     equals(turnrate(fake,outside,trades_north),0.08),
     equals(turnrate(fake,outside,stubbings_east),0.2),
     equals(turnrate(fake,outside,station_west),0.2),
...
% they give the green time for each stage in the 4 traffic signals
  ...
  change_flow(600,hepton_south,0.15),
     wait(pelican, 25)
],
